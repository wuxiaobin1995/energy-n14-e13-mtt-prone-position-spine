<!--
 * @Author      : Mr.bin
 * @Date        : 2023-06-20 17:19:57
 * @LastEditTime: 2023-06-20 17:20:07
...
export default {
  ...
  methods: {
    ...
    sendData() {
      ...
      const api = `http://${mttIP}/energy_t6_m5_mtt/public/index.php/pronePosition/sendPronePositionAssessData`
      console.log(api)
